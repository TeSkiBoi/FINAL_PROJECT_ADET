...
public class SeniorPanel extends JPanel {
    ...
    public SeniorPanel() {
        ...
        searchPanel.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createTitledBorder("Search Senior Citizen (60+ years)"),
        ...
        scrollPane.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createTitledBorder("Senior Citizens List (60+ years)"),
            BorderFactory.createEmptyBorder(5, 5, 5, 5)));
    ...
    private void loadSeniors() {
        ...
        try {
            ...
            if (seniors.isEmpty()) {
                tableModel.addRow(new Object[]{"", "No senior citizens found", "Add residents through Households", "", ""});
            } else {
            ...
            JOptionPane.showMessageDialog(this, "Error loading seniors: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
}
